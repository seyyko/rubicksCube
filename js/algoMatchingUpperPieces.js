...
export async function matchingUpperEdges(map, history, panel=null, animationDuration=0, colored=false){
...
export async function matchingUpperCorners(map, history, panel=null, animationDuration=0, colored=false){
